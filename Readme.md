# OTUS ДЗ Архитектура сетей (Centos 7)
-----------------------------------------------------------------------
### Домашнее задание
```
...
![image](https://raw.githubusercontent.com/staybox/otus_dz16/master/screenshots/arch.png)

#### Как запустить:

```git clone git@github.com:staybox/otus_dz16.git && cd otus_dz16 && vagrant up```
